 ...
 * Description: Faster trig functions for use when speed is needed without the
...
public class FastMath {
	...
	// 60 = 1.5541
	// 100 = 1.5608
	// table size for 100 = 10,000 atan operations
	private static int ATAN_LOOKUP_MAX = 40;
	/**
	 * 2PI
	 */
	public final static double TPI = Math.PI * 2;
	/**
	 * PI/2
	 */
	 ...
	 * PI/4
	 */
	public final static double PI4 = Math.PI / 4;
	...
	/**
	 * Initialize the lookup tables<br />
	 * Making LOOKUP_MAX larger increases the lookup table size and
	 * initialization time, but increases accuracy for larger values. For
	 * example, PI/2 = 1.570796. For max values:<br />
	 * 20 = 1.5208<br />
	 * 30 = 1.5375<br />
	 * 40 = 1.5458<br />
	 * 50 = 1.5508<br />
	 ...
	 * table size for 100 = 10,000 atan operations
	 *
	 * @param max precision scale
	 */
	public static void initLookupTables(int max) {
		if (max > ATAN_LOOKUP_MAX) {
			ATAN_LOOKUP_MAX = max;
			tanLookupTable = null;
		}
		initLookupTables();
